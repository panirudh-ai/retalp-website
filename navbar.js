(function () {
  ...
  style.textContent = `
    .nav-island {
      ...
      box-shadow: 0 2px 20px rgba(0,0,0,0.08), 0 0 0 3px rgba(16,185,129,0.06) inset;
      transition: all .35s cubic-bezier(.4,0,.2,1); white-space: nowrap;
    }
    .nav-island.scrolled {
      background: rgba(255,255,255,0.98); border-color: rgba(16,185,129,0.5);
      box-shadow: 0 4px 28px rgba(0,0,0,0.1), 0 0 0 3px rgba(16,185,129,0.08) inset;
    }
    ...
    .nav-logo-text { font-family: var(--sans, 'Inter', sans-serif); font-weight: 700; font-size: 1rem; letter-spacing: -0.02em; color: #0a0a0a; }
    ...
    .nav-link {
      ...
      color: rgba(0,0,0,0.5); text-decoration: none; border-radius: 100px; transition: color 0.2s;
    }
    .nav-link::before {
